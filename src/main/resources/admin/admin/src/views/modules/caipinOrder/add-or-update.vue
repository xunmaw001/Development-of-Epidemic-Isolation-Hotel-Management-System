        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="就餐餐桌" prop="caipinOrderCanzhuoTypes">
                        <el-select v-model="ruleForm.caipinOrderCanzhuoTypes" :disabled="ro.caipinOrderCanzhuoTypes" placeholder="请选择就餐餐桌">
                            <el-option
                                v-for="(item,index) in caipinOrderCanzhuoTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="就餐餐桌" prop="caipinOrderCanzhuoValue">
                        <el-input v-model="ruleForm.caipinOrderCanzhuoValue"
                            placeholder="就餐餐桌" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
    ...
    export default {
        data() {
            return {
                ...
                caipinOrderCanzhuoTypesOptions : [],
                ...
                rules: {
                   ...
                   caipinOrderCanzhuoTypes: [
                              { required: true, message: '就餐餐桌不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=caipin_order_canzhuo_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.caipinOrderCanzhuoTypesOptions = data.data.list;
                    }
                });
                this.$http({
