    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="入住编号" prop="ruzhuUuidNumber">
                       <el-input v-model="ruleForm.ruzhuUuidNumber"
                                 placeholder="入住编号" clearable  :readonly="ro.ruzhuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="入住编号" prop="ruzhuUuidNumber">
                           <el-input v-model="ruleForm.ruzhuUuidNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房间号" prop="ruzhuName">
                       <el-input v-model="ruleForm.ruzhuName"
                                 placeholder="房间号" clearable  :readonly="ro.ruzhuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="房间号" prop="ruzhuName">
                           <el-input v-model="ruleForm.ruzhuName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="体温" prop="ruzhuTiwen">
                       <el-input v-model="ruleForm.ruzhuTiwen"
                                 placeholder="体温" clearable  :readonly="ro.ruzhuTiwen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="体温" prop="ruzhuTiwen">
                           <el-input v-model="ruleForm.ruzhuTiwen"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.ruzhuPhoto" label="健康码" prop="ruzhuPhoto">
                        <file-upload
                            tip="点击上传健康码"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.ruzhuPhoto?$base.url+ruleForm.ruzhuPhoto:''"
                            @change="ruzhuPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.ruzhuPhoto" label="健康码" prop="ruzhuPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.ruzhuPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.ruzhuFile" label="附件" prop="ruzhuFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.ruzhuFile?$base.url+ruleForm.ruzhuFile:''"
                                @change="ruzhuFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.ruzhuFile" label="附件" prop="ruzhuFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.ruzhuFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.ruzhuTime"  class="input" label="入住时间" prop="ruzhuTime">
                        <el-date-picker
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.tuifangTime"  class="input" label="退房时间" prop="tuifangTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.ruzhuContent"  label="入住备注" prop="ruzhuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.ruzhuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.ruzhuContent" label="入住备注" prop="ruzhuContent">
                            <span v-html="ruleForm.ruzhuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    yonghuId: '',
                    ruzhuUuidNumber: new Date().getTime(),
                    ruzhuName: '',
                    ruzhuTiwen: '',
                    ruzhuPhoto: '',
                    ruzhuFile: '',
                ...
                rules: {
                   ...
                   ruzhuUuidNumber: [
                              { required: true, message: '入住编号不能为空', trigger: 'blur' },
                          ],
                   ruzhuName: [
                   ...
                   ruzhuContent: [
                              { required: true, message: '入住备注不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.ruzhuContent = _this.ruleForm.ruzhuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.ruzhuContent = this.ruleForm.ruzhuContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`ruzhu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.ruzhuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            ruzhuPhotoUploadChange(fileUrls){
                this.ruleForm.ruzhuPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
            ruzhuFileUploadChange(fileUrls){
                this.ruleForm.ruzhuFile = fileUrls;
                this.addEditUploadStyleChange()
            },
