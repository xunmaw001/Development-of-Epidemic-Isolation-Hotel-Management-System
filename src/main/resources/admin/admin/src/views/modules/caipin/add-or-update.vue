               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="菜品类型" prop="caipinTypes">
                        <el-select v-model="ruleForm.caipinTypes" :disabled="ro.caipinTypes" placeholder="请选择菜品类型" @change="caipinTypesChange">
                            <el-option
                ...
                <el-col :span="12" v-if="ruleForm.caipinTypes != null && ruleForm.caipinTypes != ''">
                    <el-form-item class="select" v-if="type!='info'"  label="二级类型" prop="caipinErjiTypes">
                        <el-select v-model="ruleForm.caipinErjiTypes" :disabled="ro.caipinErjiTypes" placeholder="请选择二级类型">
                            <el-option
                                v-for="(item,index) in caipinErjiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="二级类型" prop="caipinErjiValue">
                        <el-input v-model="ruleForm.caipinErjiValue"
                            placeholder="二级类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="菜品数量" prop="caipinKucunNumber">
                       <el-input v-model="ruleForm.caipinKucunNumber"
                                 placeholder="菜品数量" clearable  :readonly="ro.caipinKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="菜品数量" prop="caipinKucunNumber">
                           <el-input v-model="ruleForm.caipinKucunNumber"
                                     placeholder="菜品数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //动态查询菜品类型
            caipinTypesChange(id){
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=caipin_erji_types&superId=${id}`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.ruleForm.caipinErjiTypes = null;
                        this.caipinErjiTypesOptions = data.data.list;
                    }
                });
            },
            //动态查询二级类型
            caipinErjiTypesChange(id){
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=caipin_erji_types&superId=${id}`,
                    method: "get"
                }).then(({ data }) => {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.caipinErjiTypesChange(data.data.caipinTypes);
