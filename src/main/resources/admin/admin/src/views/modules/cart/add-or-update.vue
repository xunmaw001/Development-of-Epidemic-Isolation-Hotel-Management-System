    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="二级类型" prop="caipinErjiValue">
                        <el-input v-model="caipinForm.caipinErjiValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="菜品数量" prop="caipinKucunNumber">
                        <el-input v-model="caipinForm.caipinKucunNumber"
                                  placeholder="菜品数量" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
