...
public class CaipinOrderView extends CaipinOrderEntity implements Serializable {
	...
	* 就餐餐桌的值
	*/
	@ColumnInfo(comment="就餐餐桌的字典表值",type="varchar(200)")
	private String caipinOrderCanzhuoValue;
	/**
	* 订单类型的值
	*/
	...
	* 获取： 就餐餐桌的值
	*/
	public String getCaipinOrderCanzhuoValue() {
		return caipinOrderCanzhuoValue;
	}
	/**
	* 设置： 就餐餐桌的值
	*/
	public void setCaipinOrderCanzhuoValue(String caipinOrderCanzhuoValue) {
		this.caipinOrderCanzhuoValue = caipinOrderCanzhuoValue;
	}
	//当前表的
	/**
	* 获取： 订单类型的值
	...
	*/
	...
	public String toString() {
		return "CaipinOrderView{" +
			", caipinOrderCanzhuoValue=" + caipinOrderCanzhuoValue +
