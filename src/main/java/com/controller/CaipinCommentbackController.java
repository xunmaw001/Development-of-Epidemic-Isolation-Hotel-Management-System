...
//        else if("用户".equals(role))
//            caipinCommentback.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(caipinCommentback.getCaipinCommentbackText()) || "null".equals(caipinCommentback.getCaipinCommentbackText())){
                caipinCommentback.setCaipinCommentbackText(null);
        }
        if("".equals(caipinCommentback.getReplyText()) || "null".equals(caipinCommentback.getReplyText())){
                caipinCommentback.setReplyText(null);
        }
